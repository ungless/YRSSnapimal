    ...
    <body>
                                ...
                                <div class="content-style-form content-style-form-2">
                                    ...
                                    <form action="new-find.php" name="new-find" method="post" enctype="multipart/form-data">
                                        ...
                                        <p><label>Description of Animal</label>
                                          ...
                                          <input type="file" name="image" accept=".jpeg,.jpg,.png,.gif"/>
                                        ...
                                        <p><input type="submit" hover>Submit</button></p>
                                    </form>
                                </div>
                            </div>
                        </div>
        ...
        <?php
          ...
          while ($row = mysql_fetch_assoc($result)) {
            ...
            <div style="background-color: white;"> <img class="bottom-images" style="padding: 0; background-color: white; margin: 0 0 0 0; " src="image_uploads/'
             . $row['image'] . '" title="' . $row['name'] . '"/></div>
            <div style="display: inline; background-colo: white; "><h2>'
            . $row['name'] .
            '</h2></div>
            </li>'."\n";
          }
