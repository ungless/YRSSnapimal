...
$query = "SELECT * FROM MEMBER_TEXT WHERE Member_ID = '157'";
...
L.marker([<?php echo $result['Geolocation_Lat']; ?>,<?php echo $result['Geolocation_Long']; ?>], { 'tags':["<?php echo $result['Geolocation_Long'];
