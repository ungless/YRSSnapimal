...
$get_surname = $result[6];
$get_summary = $result[10];
$get_locations = $result[11];

$get_summary = str_replace("'", '', $get_summary);
...
$subquery3 = "SELECT MEMBER_IMAGE.Member_ID, STATUS , Image_Type, Image FROM MEMBER_IMAGE WHERE Image_Type = 'Summary' AND STATUS = 'Publish'
