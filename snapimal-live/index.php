...
<html lang="en" class="no-js">
    ...
    <body>
        <div class="container">
            ...
            <h1 style="background-color: #5F545A; color: white; width: 100%; display: relative;">What is it?</h1>
        ...
        <?php
          ...
          while ($row = mysql_fetch_assoc($result)) {
            echo '<li style="list-style-type: none; float: left; display: inline; margin: 0; height: 100%; background-color: #5F545A; text-align: center; padding: 0 !important; width: 20%; text-align: center;">
        ...
        $select_from_db = "SELECT * FROM $tbl_name ORDER BY id desc LIMIT 5";
                  ...
                  while ($row = mysql_fetch_assoc($result)) {
                    $markers = $markers
                      ...
                      . $row['name'] . '</br>'.$row['description']. '</h1>'
                      . '"),';
        ...
        var Mammal = new LeafIcon({iconUrl: 'img/Mammal.svg'}),
            Water = new LeafIcon({iconUrl: 'img/water.svg'}),
...
{
for(i=0; i<=markers.length; i++){
if(markers[i] && markers[i].options.tags.indexOf("Reptiles")> -1){
map.addLayer(markers[i]);
}
}
}
